...
// const balancesFile = './phase-3-dai-boxauq.json';
// const balancesFile = './phase-3-dai-boxayp.json';
// const balancesFile = './phase-3-usdc-boxavg.json';
// const balancesFile = './phase-3-usdc-boxayo.json';
// const balancesFile = './phase-3-eos-boxavg.json';
const balancesFile = './phase-3-eos-boxauq.json';
...
balancesFileJson.forEach(el => {
    if(el.key) {
        const USDC = Number(el.RUSDC);
        const DAI = Number(el.RDAI);
...
const propose = async (splitArray, i) => {
    ...
    const proposeInput = {
        ...
        requested,
        trx: {
            expiration: '2022-04-29T23:11:48',
            ref_block_num: 22480,
